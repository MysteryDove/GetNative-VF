...
// Auto is capability-driven: CUDA supports p=1..4, discrete Vulkan currently
// supports p=1, and CPU is the universal fallback.
[[nodiscard]] constexpr AutomaticBackend choose_automatic_backend(
    ...
    if (vulkan_available && vulkan_is_discrete && p_norm == 1U) {
