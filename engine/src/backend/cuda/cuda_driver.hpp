...
struct DriverApi {
    ...
    using ModuleLoadDataEx = CUresult(CUDAAPI *)(
    ...
    using FuncGetAttribute = CUresult(CUDAAPI *)(int *, CUfunction_attribute, CUfunction);
    ...
    ModuleLoadDataEx module_load_data_ex = nullptr;
