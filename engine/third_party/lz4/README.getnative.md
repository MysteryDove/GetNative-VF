...
- LZ4 version: 1.10.0 (upstream release tarball), `lib/lz4.c` + `lib/lz4.h`
  verbatim, BSD-2-Clause (`LICENSE`).
- xxHash version: 0.8.3 upstream `xxhash.c`/`xxhash.h`, BSD-2-Clause.
  It provides the plan-store XXH64 checksum plus XXH3/XXH32 compatibility
  hashes for LSMASH Works media indexes.
